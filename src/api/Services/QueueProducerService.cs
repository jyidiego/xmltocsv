...
namespace APIService.Services
{
  public class QueueProducerService : IQueueProducerService
  {
    ...
    private ILogger<QueueProducerService> _logger; 
    private IMetricsRepository _metricsRepository;
    private IConnection _connection;       
    public QueueProducerService(ILoggerFactory loggerFactory, IMetricsRepository metricsRepository)
    {
      _metricsRepository = metricsRepository;
      _logger = loggerFactory.CreateLogger<QueueProducerService>();
    ...
    public void WriteToQueue(string exchangeName, string queueName, string routingKeyName, string message)
    {
